...
import { createJawabanQuiz } from '../../redux/actions/jawabanQuizActions'
import { Spinner } from "react-bootstrap"
import { useEffect, useState } from "react"


const ModalTambahJawaban = ({
  createJawabanQuiz,
  data,
  alert,
  clearAlert
  ...
  return (
    <div className="modal fade" id="tambah-jawaban" style={{display: 'none'}} aria-hidden="true">
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          <div className="modal-header">
            <h4 className="modal-title">Tambah Jawaban</h4>
