...
import { createSoalQuiz } from '../../redux/actions/soalQuizActions'
import { Spinner } from "react-bootstrap"
import { useState } from "react"


const ModalTambahSoal = ({
  createSoalQuiz,
  data,
  alert,
  clearAlert
  ...
  return (
    <div className="modal fade" id="tambah-soal" style={{display: 'none'}} aria-hidden="true">
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          <div className="modal-header">
            <h4 className="modal-title">Tambah Soal</h4>
